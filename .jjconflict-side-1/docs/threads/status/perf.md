...
> all three terminals (qt, ghostty-main, ghostty-1.3.1) when loadavg < ~3 and WindowServer is
> idle, then refresh `docs/benchmarks/vtebench-baseline.md`) and (2) an optional **SIMD NEON
> decode** lever (no
