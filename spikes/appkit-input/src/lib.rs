...
//! `NSView` into `qwertty-term-input`'s encoder.
//!
...
//! correctly from AppKit into `qwertty_term_input::key_encode::encode`, and settle
...
//!
//! Structure:
//! - [`keymap`] — macOS native keycode -> `qwertty_term_input::key::Key`.
